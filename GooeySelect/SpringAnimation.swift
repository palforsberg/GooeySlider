...
class SpringAnimation {
    ...
    class func animateCalmly(layer: CALayer,
        ...
        let animation = create(keypath: keypath, duration: duration,
                               fromValue: fromValue as AnyObject, toValue: toValue as AnyObject)
    ...
    class func animate(layer: GooeyLayer,
        ...
        let animation = createSpring(keypath: keypath, duration: duration,
    ...
    class func createSpring(keypath: String,
        ...
        let values = animationValues(fromValue: fromValue, toValue: toValue,
    ...
    class func animationValues(fromValue: Double, toValue: Double,
        ...
        for point in (0..<numOfPoints) {
            ...
            let valueNormalized = animationValuesNormalized(x: x,
